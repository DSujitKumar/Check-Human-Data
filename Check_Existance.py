...
for i in filename:
	...
	threshold1 = 1.10    # set yourself to meet your requirement
	if(distance <= threshold1):
		print("distance = "+str(distance))
		print("Result : Person Present in Data")
		break
	else:
		counter=counter+1
if(counter==len(filename)):
	
	print("Result : No Person Found")
